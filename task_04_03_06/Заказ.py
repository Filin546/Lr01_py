...
# Выполнил: Пантелеев Н.А.
# Группа: ПИН-б-о-22-1
# E-mail: nikitapanteleev40@gmail.com
...
class Заказ:
    ...
    def __str__(self):
        ...
        res = (
                ...
                '\n'.join([f'{i + 1}. ' + str(pizza) for i, pizza in enumerate(self.заказанные_принадлежности)]))
        return res

    def добавить(self, принадлежности):
        """Добавить пиццу в заказ."""
        self.заказанные_пиццы.append(принадлежности)

    def сумма(self):
        """Вернуть сумму заказа."""
        return sum(accessories.цена for accessories in self.заказанные_принадлежности)
    ...
    def выполнить(self):
        ...
        """
        for i, accessories in enumerate(self.заказанные_принадлежности, start=1):
            print(f'{i}. {accessories.название}')
            accessories.формирование()
            accessories.упаковать()
